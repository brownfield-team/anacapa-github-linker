$(document).ready(function () {
    console.log("document.read fired in courses.js")

    document.addEventListener("change", function (e) {

        console.log("change function fired")
        if($("#course-admin-panel").length){
            courseRosterCSV(e)
        } else if($("#course-informed-consent-panel").length){
            informedConsentCSV(e)
        } else {
            console.log("Unknown change event in courses.js")
        }
     });
 });
